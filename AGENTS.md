...
> Network-wide rules: [`~/Straightway-Network/GEMINI.md`](../../GEMINI.md) · orchestration: [`AGENTS.md`](../../AGENTS.md) · change log: [`docs/APP-DOCS-CHANGELOG.md`](../../docs/APP-DOCS-CHANGELOG.md)
